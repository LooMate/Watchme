...
-- DROP TABLE IF EXISTS "userWebDetails";

-- DROP SEQUENCE IF EXISTS "user_web_details_id_seq";
...
-- DROP TABLE IF EXISTS "userTelegramDetails";

-- DROP SEQUENCE IF EXISTS "user_telegram_details_id_seq";
...
-- DROP TABLE IF EXISTS "telegramChannelDetails";
-- DROP SEQUENCE IF EXISTS "telegram_channel_details_id_seq";
